...
const TEAM = [
  {
    ...
    photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop&crop=face&auto=format&q=75",
    rating: 97,
    strengths: [
      { label: "Leadership", value: 97 },
      { label: "Strategy",   value: 95 },
      { label: "Vision",     value: 98 },
      { label: "Delivery",   value: 93 },
    ],
    details: {
      experience:     "12 Years",
      education:      "MSc Civil Engineering, University of Nairobi",
      certifications: "PMP, ISO 9001 Lead Auditor",
      projects:       "47 Completed Projects",
    },
    quote:     "We don't just build structures — we build the future communities will live in.",
    years:     "12 yrs",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=500&fit=crop&crop=face&auto=format&q=75",
    rating: 94,
    strengths: [
    ...
    details: {
      experience:     "9 Years",
      education:      "BEng Structural Engineering, JKUAT",
      certifications: "CEng, IStructE Member",
      projects:       "31 Completed Projects",
    },
    quote:     "Every millimetre matters. Engineering is the discipline of getting it right.",
    years:     "9 yrs",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop&crop=face&auto=format&q=75",
    rating: 92,
    strengths: [
      { label: "Planning",         value: 94 },
      { label: "Team Building",    value: 93 },
      { label: "Risk Mgmt",        value: 91 },
      { label: "Client Relations", value: 96 },
    ],
    details: {
      experience:     "7 Years",
      education:      "BSc Project Management, Wits University",
      certifications: "PRINCE2 Practitioner, Agile PM",
      projects:       "24 Completed Projects",
    },
    quote:     "A project delivered on time is a promise kept. I take that personally.",
    years:     "7 yrs",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=500&fit=crop&crop=face&auto=format&q=75",
    rating: 90,
    strengths: [
      { label: "Design",         value: 95 },
      { label: "Sustainability", value: 93 },
      { label: "Research",       value: 89 },
      { label: "Creativity",     value: 96 },
    ],
    details: {
      experience:     "6 Years",
      education:      "MArch Architecture, University of Ghana",
      certifications: "LEED AP, RIBA Part III",
      projects:       "18 Completed Projects",
    },
    quote:     "Good design is invisible. Great design changes how people live.",
    years:     "6 yrs",
  ...
  },
  {
    ...
    role: "HSEQ Manager",
    photo: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=500&fit=crop&crop=face&auto=format&q=75",
    rating: 93,
    strengths: [
      { label: "Safety",     value: 98 },
      { label: "Compliance", value: 96 },
      { label: "Training",   value: 92 },
      { label: "Auditing",   value: 94 },
    ],
    details: {
      experience:     "8 Years",
      education:      "BSc Occupational Health & Safety, UoN",
      certifications: "NEBOSH IGC, ISO 45001 Lead Auditor",
      projects:       "Zero LTI Record — 8 Years",
    },
    quote:     "Zero harm is not a target — it is the only acceptable standard.",
    years:     "8 yrs",
